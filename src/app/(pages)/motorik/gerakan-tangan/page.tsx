...
const videoData = [
  {
    url: "https://www.youtube.com/watch?v=5RezsWTnj10",
    title: "LATIHAN SEDERHANA BAGI PASIEN STROKE",
  },
  {
    url: "https://www.youtube.com/watch?v=xLhBF2YWetQ",
    title: "Melatih tangan yang lumpuh akibat stroke",
  },
];

export default function GerakanTanganPage() {
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Gerakan tangan yang efektif untuk tubuh.
                </p>
