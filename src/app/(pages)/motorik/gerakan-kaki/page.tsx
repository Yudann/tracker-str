...
const videoData = [
  {
    url: "https://www.youtube.com/watch?v=kHQcMVeVs88",
    title: "Melatih Jalan Pasien Stroke Dirumah",
  },
  {
    url: "https://www.youtube.com/watch?v=FbcviRv3ixY",
    title: "Latihan Fisioterapi Pasca Stroke Dirumah",
  },
];

export default function GerakanKakiPage() {
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Gerakan kaki yang efektif untuk tubuh.
                </p>
