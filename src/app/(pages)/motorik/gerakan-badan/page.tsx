...
const videoData = [
  {
    url: "https://www.youtube.com/watch?v=dAfkXu2oAfM",
    title: "LATIHAN DUDUK DAN BERDIRI UNTUK ORANG STROKE ",
  },
  {
    url: "https://www.youtube.com/watch?v=hxeeA7EHiDE",
    title: "Latihan Fungsional Pasien Post Stroke Stadium Placid",
  },
];

export default function GerakanBadanPage() {
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Gerakan peregangan badan yang efektif.
                </p>
